...
class SocketMainWindow(QtGui.QMainWindow, New_File, New_Dir , User_l, User_S):
    ...
    def dragEnterEvent(self, event):
        if event.mimeData().hasUrls():
          ...
          super(SocketMainWindow, self).dragEnterEvsent(event)
    ...
    def Make_sock_Win(self,provider_username):
        self.sockapp = QtGui.QApplication(sys.argv)
        self.sockWin = SocketMainWindow()
        self.sockWin.start_show(self.sockapp)
        #self.Us
