...
class SocketMainWindow(QtGui.QMainWindow, New_File, New_Dir,User_D,User_S):
    ...
    def setup(self):
        ...
        if history_list[self.window_index][here[self.window_index][0]][0] != "*":
            self.ui.listView.doubleClicked.connect(lambda: sock_list_Dclicked(history_list[self.window_index][here[self.window_index][0]][0], str(self.ui.listView.currentItem().text()),self.ui.listView,self.ui.lineEdit, self.window_index))
        self.ui.listView.itemClicked.connect(self.selected_saver)
    ...
    def keyPressEvent(self, event):
        if event.key() == QtCore.Qt.Key_Return:
            if self.ui.listView.currentItem():
                sock_list_Dclicked(history_list[self.window_index][here[self.window_index][0]][0], str(self.ui.listView.currentItem().text()), self.ui.listView, self.ui.lineEdit, self.window_index)
    ...
    def contextMenuEvent(self , event):
        ...
        if selected_item[0] != "" :
            ...
            open_actio.triggered.connect(lambda: sock_list_Dclicked(history_list[self.window_index][here[self.window_index][0]][0], str(self.ui.listView.currentItem().text()),self.ui.listView,self.ui.lineEdit, self.window_index))
