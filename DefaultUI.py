...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
       ...
       # self.menuVirtual = QtGui.QMenu(self.menubar)
        ...
        self.actionNewDir = QtGui.QAction(MainWindow)
        self.actionNewDir.setObjectName(_fromUtf8("actionNewDir"))
       ...
       # self.actionOpen_shell = QtGui.QAction(MainWindow)
        ...
        self.menuFile.addAction(self.actionNewDir)
    ...
    def retranslateUi(self, MainWindow):
       ...
       # self.menuVirtual.setTitle(_translate("MainWindow", "Virtual", None))
        ...
        self.actionNewDir.setText(_translate("MainWindow", "NewDir", None))
